...
public class Editor
{
    ...
    private static void ApplyDemoBoard512()
    {
        Item[,] Board = new Item[,] {
    ...
    [MenuItem("Tools/Project 2048/Demo Board 256")]
    private static void ApplyDemoBoard256()
    {
        Item[,] Board = new Item[,] {
            { new Item(8),new Item(64), new Item(256),new Item(256) },
            { new Item(0),new Item(32), new Item(64),new Item(16) },
            { new Item(2),new Item(0), new Item(0),new Item(0) },
            { new Item(0),new Item(0), new Item(2),new Item(0) }
         };
    ...
    [MenuItem("Tools/Project 2048/Demo Board 128")]
    private static void ApplyDemoBoard128()
    {
        Item[,] Board = new Item[,] {
            { new Item(64),new Item(64), new Item(128),new Item(128) },
            { new Item(2),new Item(128), new Item(64),new Item(16) },
            { new Item(2),new Item(0), new Item(0),new Item(0) },
            { new Item(0),new Item(0), new Item(2),new Item(0) }
         };
        Main.Instance.Core.Reload(new Game()
    ...
    [MenuItem("Tools/Project 2048/Demo Board Chain to 64")]
    private static void ApplyDemoBoard64()
    {
        Item[,] Board = new Item[,] {
            { new Item(32),new Item(32), new Item(64),new Item(64) },
            { new Item(8),new Item(64), new Item(4),new Item(8) },
            { new Item(2),new Item(0), new Item(0),new Item(0) },
            { new Item(0),new Item(0), new Item(2),new Item(0) }
         };
        Main.Instance.Core.Reload(new Game()
